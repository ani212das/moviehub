...
{
    public abstract class moviehubWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static moviehubWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(moviehubWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<moviehubDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<moviehubDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<moviehubDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<moviehubDbContext, Task<T>> func)
        {
            T result;
